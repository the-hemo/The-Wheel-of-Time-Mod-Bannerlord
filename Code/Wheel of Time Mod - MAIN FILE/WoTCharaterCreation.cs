...
namespace WoT_Main
{
    ...
    public class WoTCharacterCreation : CharacterCreationContentBase
    {
        ...
        protected void AddOriginMenu(CharacterCreation characterCreation)
        {
            ...
            characterCreationCategory1.AddCategoryOption(new TextObject("an offshot of a cheftan's family", null), new MBList<SkillObject>{
            ...
            characterCreationCategory1.AddCategoryOption(new TextObject("born into a family of farmers", null), new MBList<SkillObject>{
            ...
            characterCreationCategory1.AddCategoryOption(new TextObject("a part of a craftsmans family", null), new MBList<SkillObject>{
                DefaultSkills.Trade,
            ...
            characterCreationCategory1.AddCategoryOption(new TextObject("closely connected to a wise one", null), new MBList<SkillObject>{
            ...
            characterCreationCategory1.AddCategoryOption(new TextObject("born into a family of warriors", null), new MBList<SkillObject>{
            ...
            characterCreationCategory1.AddCategoryOption(new TextObject("kin to wasteland traders", null), new MBList<SkillObject>{
                DefaultSkills.Trade,
            ...
            characterCreationCategory.AddCategoryOption(new TextObject("born in a family of darkfriends", null), new MBList<SkillObject>{
            ...
            characterCreationCategory.AddCategoryOption(new TextObject("a member of the black Ajah", null), new MBList<SkillObject>{
                DefaultSkills.Throwing,
                DefaultSkills.Medicine
                },
            ...
            characterCreationCategory.AddCategoryOption(new TextObject("a Samma N'Sei", null), new MBList<SkillObject>{
                DefaultSkills.Throwing,
                DefaultSkills.Medicine
                },
            ...
            characterCreationCategory.AddCategoryOption(new TextObject("a daughter of a dreadlord", null), new MBList<SkillObject>{
                DefaultSkills.Tactics,
                DefaultSkills.Steward
                },
            ...
            characterCreationCategory.AddCategoryOption(new TextObject("a son of a dreadlord", null), new MBList<SkillObject>{
                DefaultSkills.Tactics,
                DefaultSkills.Steward
                },
            ...
            characterCreationCategory.AddCategoryOption(new TextObject("an offspring of slaves", null), new MBList<SkillObject>{
                DefaultSkills.Roguery,
                DefaultSkills.Polearm
                },
            ...
            characterCreationCategoryDefault.AddCategoryOption(new TextObject("part of a farmer's household", null), new MBList<SkillObject>{
                DefaultSkills.Athletics,
                DefaultSkills.Riding
                },
            ...
            characterCreationCategoryDefault.AddCategoryOption(new TextObject("a relative of a wisdom", null), new MBList<SkillObject>{
                DefaultSkills.Medicine,
                DefaultSkills.Charm
                },
            ...
            characterCreationCategoryDefault.AddCategoryOption(new TextObject("a daughter of a labourer", null), new MBList<SkillObject>{
                DefaultSkills.Crafting,
                DefaultSkills.OneHanded
                },
            ...
            characterCreationCategoryDefault.AddCategoryOption(new TextObject("a son of a labourer", null), new MBList<SkillObject>{
                DefaultSkills.Crafting,
                DefaultSkills.OneHanded
                },
            ...
            characterCreationCategoryDefault.AddCategoryOption(new TextObject("an offspring of a noble", null), new MBList<SkillObject>{
            ...
            characterCreationCategoryDefault.AddCategoryOption(new TextObject("born into a family of shopkeepers", null), new MBList<SkillObject>{
                DefaultSkills.Trade,
                DefaultSkills.Charm
                },
            ...
            characterCreationCategoryDefault.AddCategoryOption(new TextObject("a bandit child", null), new MBList<SkillObject>{
                DefaultSkills.Bow,
                DefaultSkills.Roguery
                },
            ...
            characterCreationCategoryWT.AddCategoryOption(new TextObject("part of a farmer's household", null), new MBList<SkillObject>{
                DefaultSkills.Athletics,
                DefaultSkills.Riding
                },
            ...
            characterCreationCategoryWT.AddCategoryOption(new TextObject("a daughter of an Aes Sedai and Warder", null), new MBList<SkillObject>{
                DefaultSkills.Throwing,
                DefaultSkills.Leadership
                },
            ...
            characterCreationCategoryWT.AddCategoryOption(new TextObject("a son of an Aes Sedai and Warder", null), new MBList<SkillObject>{
                DefaultSkills.Throwing,
                DefaultSkills.Leadership
                },
            ...
            characterCreationCategoryWT.AddCategoryOption(new TextObject("a daughter of a labourer", null), new MBList<SkillObject>{
                DefaultSkills.Crafting,
                DefaultSkills.OneHanded
                },
                DefaultCharacterAttributes.Vigor, this.FocusToAdd, this.SkillLevelToAdd, this.AttributeLevelToAdd, Female, default_poor_2_OnApply, default_poor_2_OnApply, new TextObject("Your father was a labourer, heading from town to town in search of jobs that suited his craft. He was working at construction sites, harbours and reparing for his entire life, sharing a great deal of that experience with you.", null), null, 0, 0, 0, 0, 0);
            characterCreationCategoryWT.AddCategoryOption(new TextObject("a son of a labourer", null), new MBList<SkillObject>{
                DefaultSkills.Crafting,
                DefaultSkills.OneHanded
                },
                DefaultCharacterAttributes.Vigor, this.FocusToAdd, this.SkillLevelToAdd, this.AttributeLevelToAdd, Male, default_poor_2_OnApply, default_poor_2_OnApply, new TextObject("Your father was a labourer, heading from town to town in search of jobs that suited his craft. He was working at construction sites, harbours and reparing for his entire life, sharing a great deal of that experience with you.", null), null, 0, 0, 0, 0, 0);
            characterCreationCategoryWT.AddCategoryOption(new TextObject("an offspring of a noble", null), new MBList<SkillObject>{
                DefaultSkills.TwoHanded,
                DefaultSkills.Leadership
                },
                DefaultCharacterAttributes.Intelligence, this.FocusToAdd, this.SkillLevelToAdd, this.AttributeLevelToAdd, null, default_rich_1_OnApply, default_rich_1_OnApply, new TextObject("You were a fourth child of some minor country nobleman, which meant you couldn't inherit his estates and were left with two options: stay with one of your brothers, looking after the estates as a squire or going of on a life of adventure. You decided on the second option.", null), null, 0, 0, 0, 0, 0);
            characterCreationCategoryWT.AddCategoryOption(new TextObject("born into a family of shopkeepers", null), new MBList<SkillObject>{
                DefaultSkills.Trade,
                DefaultSkills.Charm
                },
                DefaultCharacterAttributes.Social, this.FocusToAdd, this.SkillLevelToAdd, this.AttributeLevelToAdd, null, default_middle_1_OnApply, default_middle_1_OnApply, new TextObject("You were part of the town's middle class, helping out in your family's shop all your life, offering sevices of different kinds to your clients and making a decent living of it.", null), null, 0, 0, 0, 0, 0);
            characterCreationCategoryWT.AddCategoryOption(new TextObject("an offspring of a turned down novice", null), new MBList<SkillObject>{
                DefaultSkills.Throwing,
                DefaultSkills.Roguery
                },
            ...
            characterCreationCategoryBT.AddCategoryOption(new TextObject("part of a farmer's household", null), new MBList<SkillObject>{
                DefaultSkills.Athletics,
                DefaultSkills.Riding
                },
                DefaultCharacterAttributes.Endurance, this.FocusToAdd, this.SkillLevelToAdd, this.AttributeLevelToAdd, null, default_poor_1_OnApply, default_poor_1_OnApply, new TextObject("You were raised at a farm in a rural area. A poor living and since you had elder brothers, they inhereted most of the farm, you were only left with your brains and clothes after you left the household.", null), null, 0, 0, 0, 0, 0);

            characterCreationCategoryBT.AddCategoryOption(new TextObject("a daughter of an Asha'man", null), new MBList<SkillObject>{
                DefaultSkills.Throwing,
                DefaultSkills.Leadership
                },
            ...
            characterCreationCategoryBT.AddCategoryOption(new TextObject("a son of an Asha'man", null), new MBList<SkillObject>{
                DefaultSkills.Throwing,
                DefaultSkills.Leadership
                },
            ...
            characterCreationCategoryBT.AddCategoryOption(new TextObject("a daughter of a labourer", null), new MBList<SkillObject>{
                DefaultSkills.Crafting,
                DefaultSkills.OneHanded
                },
                DefaultCharacterAttributes.Vigor, this.FocusToAdd, this.SkillLevelToAdd, this.AttributeLevelToAdd, Female, default_poor_2_OnApply, default_poor_2_OnApply, new TextObject("Your father was a labourer, heading from town to town in search of jobs that suited his craft. He was working at construction sites, harbours and reparing for his entire life, sharing a great deal of that experience with you.", null), null, 0, 0, 0, 0, 0);
            characterCreationCategoryBT.AddCategoryOption(new TextObject("a son of a labourer", null), new MBList<SkillObject>{
                DefaultSkills.Crafting,
                DefaultSkills.OneHanded
                },
                DefaultCharacterAttributes.Vigor, this.FocusToAdd, this.SkillLevelToAdd, this.AttributeLevelToAdd, Male, default_poor_2_OnApply, default_poor_2_OnApply, new TextObject("Your father was a labourer, heading from town to town in search of jobs that suited his craft. He was working at construction sites, harbours and reparing for his entire life, sharing a great deal of that experience with you.", null), null, 0, 0, 0, 0, 0);
            characterCreationCategoryBT.AddCategoryOption(new TextObject("an offspring of a noble", null), new MBList<SkillObject>{
                DefaultSkills.TwoHanded,
                DefaultSkills.Leadership
                },
                DefaultCharacterAttributes.Intelligence, this.FocusToAdd, this.SkillLevelToAdd, this.AttributeLevelToAdd, null, default_rich_1_OnApply, default_rich_1_OnApply, new TextObject("You were a fourth child of some minor country nobleman, which meant you couldn't inherit his estates and were left with two options: stay with one of your brothers, looking after the estates as a squire or going of on a life of adventure. You decided on the second option.", null), null, 0, 0, 0, 0, 0);
            characterCreationCategoryBT.AddCategoryOption(new TextObject("born into a family of shopkeepers", null), new MBList<SkillObject>{
                DefaultSkills.Trade,
                DefaultSkills.Charm
                },
                DefaultCharacterAttributes.Social, this.FocusToAdd, this.SkillLevelToAdd, this.AttributeLevelToAdd, null, default_middle_1_OnApply, default_middle_1_OnApply, new TextObject("You were part of the town's middle class, helping out in your family's shop all your life, offering sevices of different kinds to your clients and making a decent living of it.", null), null, 0, 0, 0, 0, 0);
            characterCreationCategoryBT.AddCategoryOption(new TextObject("a black tower initiate", null), new MBList<SkillObject>{
                DefaultSkills.Throwing,
                DefaultSkills.Roguery
                },
            ...
            characterCreationCategoryDragon.AddCategoryOption(new TextObject("a former follower of the Prophet", null), new MBList<SkillObject>{
                DefaultSkills.Polearm,
                DefaultSkills.Roguery
                },
            ...
            characterCreationCategoryDragon.AddCategoryOption(new TextObject("a relative of a wisdom", null), new MBList<SkillObject>{
                DefaultSkills.Medicine,
                DefaultSkills.Charm
                },
                DefaultCharacterAttributes.Social, this.FocusToAdd, this.SkillLevelToAdd, this.AttributeLevelToAdd, null, default_channeler_1_OnApply, default_channeler_1_OnApply, new TextObject("As a relative of your villages wisdom you had a good living, learning a lot from her. You even inherited the ability to channel from her, incredible luck.", null), null, 0, 0, 0, 0, 0);
            characterCreationCategoryDragon.AddCategoryOption(new TextObject("a daughter of a dead Legion of the Dragon officer", null), new MBList<SkillObject>{
                DefaultSkills.OneHanded,
                DefaultSkills.TwoHanded
                },
            ...
            characterCreationCategoryDragon.AddCategoryOption(new TextObject("a son of a dead Legion of the Dragon officer", null), new MBList<SkillObject>{
                DefaultSkills.OneHanded,
                DefaultSkills.TwoHanded
                },
            ...
            characterCreationCategoryDragon.AddCategoryOption(new TextObject("a Two Rivers bowman", null), new MBList<SkillObject>{
                DefaultSkills.Bow,
                DefaultSkills.Athletics
                },
            ...
            characterCreationCategoryDragon.AddCategoryOption(new TextObject("a Two Rivers bow-woman", null), new MBList<SkillObject>{
                DefaultSkills.Bow,
                DefaultSkills.Athletics
                },
            ...
            characterCreationCategoryDragon.AddCategoryOption(new TextObject("born into a family of shopkeepers", null), new MBList<SkillObject>{
                DefaultSkills.Trade,
                DefaultSkills.Charm
                },
                DefaultCharacterAttributes.Social, this.FocusToAdd, this.SkillLevelToAdd, this.AttributeLevelToAdd, null, default_middle_1_OnApply, default_middle_1_OnApply, new TextObject("You were part of the town's middle class, helping out in your family's shop all your life, offering sevices of different kinds to your clients and making a decent living of it.", null), null, 0, 0, 0, 0, 0);
            characterCreationCategoryDragon.AddCategoryOption(new TextObject("a recruit of the Band of the Red Hand", null), new MBList<SkillObject>{
                DefaultSkills.TwoHanded,
                DefaultSkills.Tactics
                },
            ...
            characterCreationCategoryBorderlands.AddCategoryOption(new TextObject("a relative of a noble", null), new MBList<SkillObject>{
                DefaultSkills.Athletics,
                DefaultSkills.Riding
                },
            ...
            characterCreationCategoryBorderlands.AddCategoryOption(new TextObject("a healer", null), new MBList<SkillObject>{
                DefaultSkills.Medicine,
                DefaultSkills.Charm
                },
            ...
            characterCreationCategoryBorderlands.AddCategoryOption(new TextObject("a daughter of scouts", null), new MBList<SkillObject>{
                DefaultSkills.Riding,
            ...
            characterCreationCategoryBorderlands.AddCategoryOption(new TextObject("a son of scouts", null), new MBList<SkillObject>{
                DefaultSkills.Crafting,
                DefaultSkills.OneHanded
                },
            ...
            characterCreationCategoryBorderlands.AddCategoryOption(new TextObject("a trolloc hunter", null), new MBList<SkillObject>{
                DefaultSkills.TwoHanded,
                DefaultSkills.Leadership
                },
            ...
            characterCreationCategoryBorderlands.AddCategoryOption(new TextObject("a frontier farmer", null), new MBList<SkillObject>{
                DefaultSkills.Athletics,
                DefaultSkills.Bow
                },
            ...
            characterCreationCategoryBorderlands.AddCategoryOption(new TextObject("a survivor of the Malkieri", null), new MBList<SkillObject>{
                DefaultSkills.TwoHanded,
                DefaultSkills.Roguery
                },
            ...
            characterCreationCategorySeanchan.AddCategoryOption(new TextObject("part of a farmer's household", null), new MBList<SkillObject>{
                DefaultSkills.Athletics,
                DefaultSkills.Riding
                },
                DefaultCharacterAttributes.Endurance, this.FocusToAdd, this.SkillLevelToAdd, this.AttributeLevelToAdd, null, default_poor_1_OnApply, default_poor_1_OnApply, new TextObject("You were raised at a farm in a rural area. A poor living and since you had elder brothers, they inhereted most of the farm, you were only left with your brains and clothes after you left the household.", null), null, 0, 0, 0, 0, 0);
            ...
            characterCreationCategorySeanchan.AddCategoryOption(new TextObject("an escaped Damane", null), new MBList<SkillObject>{
                DefaultSkills.Throwing,
                DefaultSkills.Roguery
                },
            ...
            characterCreationCategorySeanchan.AddCategoryOption(new TextObject("a survived male channeler", null), new MBList<SkillObject>{
                DefaultSkills.Throwing,
                DefaultSkills.Roguery
                },
            ...
            characterCreationCategorySeanchan.AddCategoryOption(new TextObject("a daughter of a labourer", null), new MBList<SkillObject>{
                DefaultSkills.Crafting,
                DefaultSkills.OneHanded
                },
                DefaultCharacterAttributes.Vigor, this.FocusToAdd, this.SkillLevelToAdd, this.AttributeLevelToAdd, Female, default_poor_2_OnApply, default_poor_2_OnApply, new TextObject("Your father was a labourer, heading from town to town in search of jobs that suited his craft. He was working at construction sites, harbours and reparing for his entire life, sharing a great deal of that experience with you.", null), null, 0, 0, 0, 0, 0);
            characterCreationCategorySeanchan.AddCategoryOption(new TextObject("a son of a labourer", null), new MBList<SkillObject>{
                DefaultSkills.Crafting,
                DefaultSkills.OneHanded
                },
                DefaultCharacterAttributes.Vigor, this.FocusToAdd, this.SkillLevelToAdd, this.AttributeLevelToAdd, Male, default_poor_2_OnApply, default_poor_2_OnApply, new TextObject("Your father was a labourer, heading from town to town in search of jobs that suited his craft. He was working at construction sites, harbours and reparing for his entire life, sharing a great deal of that experience with you.", null), null, 0, 0, 0, 0, 0);
            characterCreationCategorySeanchan.AddCategoryOption(new TextObject("part of the Seanchan minor blood", null), new MBList<SkillObject>{
                DefaultSkills.Tactics,
                DefaultSkills.Leadership
                },
            ...
            characterCreationCategorySeanchan.AddCategoryOption(new TextObject("a relative of a Deathwatch Guard", null), new MBList<SkillObject>{
                DefaultSkills.TwoHanded,
                DefaultSkills.Athletics
                },
            ...
            characterCreationCategorySeanchan.AddCategoryOption(new TextObject("a recruit in the army of the Seanchan", null), new MBList<SkillObject>{
                DefaultSkills.Bow,
                DefaultSkills.Polearm
                },
            ...
            characterCreationCategoryAmadicia.AddCategoryOption(new TextObject("part of a farmer's household", null), new MBList<SkillObject>{
                DefaultSkills.Athletics,
                DefaultSkills.Riding
                },
                DefaultCharacterAttributes.Endurance, this.FocusToAdd, this.SkillLevelToAdd, this.AttributeLevelToAdd, null, default_poor_1_OnApply, default_poor_1_OnApply, new TextObject("You were raised at a farm in a rural area. A poor living and since you had elder brothers, they inhereted most of the farm, you were only left with your brains and clothes after you left the household.", null), null, 0, 0, 0, 0, 0);
            characterCreationCategoryAmadicia.AddCategoryOption(new TextObject("a relative of a wisdom", null), new MBList<SkillObject>{
                DefaultSkills.Medicine,
                DefaultSkills.Charm
                },
                DefaultCharacterAttributes.Social, this.FocusToAdd, this.SkillLevelToAdd, this.AttributeLevelToAdd, null, default_channeler_1_OnApply, default_channeler_1_OnApply, new TextObject("As a relative of your villages wisdom you had a good living, learning a lot from her. You even inherited the ability to channel from her, incredible luck.", null), null, 0, 0, 0, 0, 0);
            characterCreationCategoryAmadicia.AddCategoryOption(new TextObject("a daughter of a labourer", null), new MBList<SkillObject>{
                DefaultSkills.Crafting,
                DefaultSkills.OneHanded
                },
                DefaultCharacterAttributes.Vigor, this.FocusToAdd, this.SkillLevelToAdd, this.AttributeLevelToAdd, Female, default_poor_2_OnApply, default_poor_2_OnApply, new TextObject("Your father was a labourer, heading from town to town in search of jobs that suited his craft. He was working at construction sites, harbours and reparing for his entire life, sharing a great deal of that experience with you.", null), null, 0, 0, 0, 0, 0);
            characterCreationCategoryAmadicia.AddCategoryOption(new TextObject("a son of a labourer", null), new MBList<SkillObject>{
                DefaultSkills.Crafting,
                DefaultSkills.OneHanded
                },
                DefaultCharacterAttributes.Vigor, this.FocusToAdd, this.SkillLevelToAdd, this.AttributeLevelToAdd, Male, default_poor_2_OnApply, default_poor_2_OnApply, new TextObject("Your father was a labourer, heading from town to town in search of jobs that suited his craft. He was working at construction sites, harbours and reparing for his entire life, sharing a great deal of that experience with you.", null), null, 0, 0, 0, 0, 0);
            characterCreationCategoryAmadicia.AddCategoryOption(new TextObject("a White Cloak", null), new MBList<SkillObject>{
                DefaultSkills.TwoHanded,
                DefaultSkills.Leadership
                },
            ...
            characterCreationCategoryAmadicia.AddCategoryOption(new TextObject("born into a family of shopkeepers", null), new MBList<SkillObject>{
                DefaultSkills.Trade,
                DefaultSkills.Charm
                },
                DefaultCharacterAttributes.Social, this.FocusToAdd, this.SkillLevelToAdd, this.AttributeLevelToAdd, null, default_middle_1_OnApply, default_middle_1_OnApply, new TextObject("You were part of the town's middle class, helping out in your family's shop all your life, offering sevices of different kinds to your clients and making a decent living of it.", null), null, 0, 0, 0, 0, 0);
            characterCreationCategoryAmadicia.AddCategoryOption(new TextObject("a loyalsit of the king", null), new MBList<SkillObject>{
                DefaultSkills.Polearm,
                DefaultSkills.Roguery
                },
            ...
            characterCreationCategoryAndor.AddCategoryOption(new TextObject("part of a farmer's household", null), new MBList<SkillObject>{
                DefaultSkills.Athletics,
                DefaultSkills.Riding
                },
                DefaultCharacterAttributes.Endurance, this.FocusToAdd, this.SkillLevelToAdd, this.AttributeLevelToAdd, null, default_poor_1_OnApply, default_poor_1_OnApply, new TextObject("You were raised at a farm in a rural area. A poor living and since you had elder brothers, they inhereted most of the farm, you were only left with your brains and clothes after you left the household.", null), null, 0, 0, 0, 0, 0);
            characterCreationCategoryAndor.AddCategoryOption(new TextObject("a relative of a wisdom", null), new MBList<SkillObject>{
                DefaultSkills.Medicine,
                DefaultSkills.Charm
                },
                DefaultCharacterAttributes.Social, this.FocusToAdd, this.SkillLevelToAdd, this.AttributeLevelToAdd, null, default_channeler_1_OnApply, default_channeler_1_OnApply, new TextObject("As a relative of your villages wisdom you had a good living, learning a lot from her. You even inherited the ability to channel from her, incredible luck.", null), null, 0, 0, 0, 0, 0);
            characterCreationCategoryAndor.AddCategoryOption(new TextObject("a daughter of a labourer", null), new MBList<SkillObject>{
                DefaultSkills.Crafting,
                DefaultSkills.OneHanded
                },
                DefaultCharacterAttributes.Vigor, this.FocusToAdd, this.SkillLevelToAdd, this.AttributeLevelToAdd, Female, default_poor_2_OnApply, default_poor_2_OnApply, new TextObject("Your father was a labourer, heading from town to town in search of jobs that suited his craft. He was working at construction sites, harbours and reparing for his entire life, sharing a great deal of that experience with you.", null), null, 0, 0, 0, 0, 0);
            characterCreationCategoryAndor.AddCategoryOption(new TextObject("a son of a labourer", null), new MBList<SkillObject>{
                DefaultSkills.Crafting,
                DefaultSkills.OneHanded
                },
                DefaultCharacterAttributes.Vigor, this.FocusToAdd, this.SkillLevelToAdd, this.AttributeLevelToAdd, Male, default_poor_2_OnApply, default_poor_2_OnApply, new TextObject("Your father was a labourer, heading from town to town in search of jobs that suited his craft. He was working at construction sites, harbours and reparing for his entire life, sharing a great deal of that experience with you.", null), null, 0, 0, 0, 0, 0);
            characterCreationCategoryAndor.AddCategoryOption(new TextObject("a noble retainer", null), new MBList<SkillObject>{
                DefaultSkills.TwoHanded,
                DefaultSkills.Leadership
                },
            ...
            characterCreationCategoryAndor.AddCategoryOption(new TextObject("a recruit in the Queens Guard", null), new MBList<SkillObject>{
                DefaultSkills.OneHanded,
                DefaultSkills.Athletics
                },
            ...
            characterCreationCategoryAndor.AddCategoryOption(new TextObject("an common levy", null), new MBList<SkillObject>{
                DefaultSkills.Polearm,
                DefaultSkills.Crafting
                },
            ...
            characterCreationCategoryCairhien.AddCategoryOption(new TextObject("part of a farmer's household", null), new MBList<SkillObject>{
                DefaultSkills.Athletics,
                DefaultSkills.Riding
                },
                DefaultCharacterAttributes.Endurance, this.FocusToAdd, this.SkillLevelToAdd, this.AttributeLevelToAdd, null, default_poor_1_OnApply, default_poor_1_OnApply, new TextObject("You were raised at a farm in a rural area. A poor living and since you had elder brothers, they inhereted most of the farm, you were only left with your brains and clothes after you left the household.", null), null, 0, 0, 0, 0, 0);
            characterCreationCategoryCairhien.AddCategoryOption(new TextObject("a relative of a wisdom", null), new MBList<SkillObject>{
                DefaultSkills.Medicine,
                DefaultSkills.Charm
                },
                DefaultCharacterAttributes.Social, this.FocusToAdd, this.SkillLevelToAdd, this.AttributeLevelToAdd, null, default_channeler_1_OnApply, default_channeler_1_OnApply, new TextObject("As a relative of your villages wisdom you had a good living, learning a lot from her. You even inherited the ability to channel from her, incredible luck.", null), null, 0, 0, 0, 0, 0);
            characterCreationCategoryCairhien.AddCategoryOption(new TextObject("a daughter of a labourer", null), new MBList<SkillObject>{
                DefaultSkills.Crafting,
                DefaultSkills.OneHanded
                },
                DefaultCharacterAttributes.Vigor, this.FocusToAdd, this.SkillLevelToAdd, this.AttributeLevelToAdd, Female, default_poor_2_OnApply, default_poor_2_OnApply, new TextObject("Your father was a labourer, heading from town to town in search of jobs that suited his craft. He was working at construction sites, harbours and reparing for his entire life, sharing a great deal of that experience with you.", null), null, 0, 0, 0, 0, 0);
            characterCreationCategoryCairhien.AddCategoryOption(new TextObject("a son of a labourer", null), new MBList<SkillObject>{
                DefaultSkills.Crafting,
                DefaultSkills.OneHanded
                },
                DefaultCharacterAttributes.Vigor, this.FocusToAdd, this.SkillLevelToAdd, this.AttributeLevelToAdd, Male, default_poor_2_OnApply, default_poor_2_OnApply, new TextObject("Your father was a labourer, heading from town to town in search of jobs that suited his craft. He was working at construction sites, harbours and reparing for his entire life, sharing a great deal of that experience with you.", null), null, 0, 0, 0, 0, 0);
            characterCreationCategoryCairhien.AddCategoryOption(new TextObject("a noble officer", null), new MBList<SkillObject>{
                DefaultSkills.Tactics,
                DefaultSkills.Leadership
                },
            ...
            characterCreationCategoryCairhien.AddCategoryOption(new TextObject("born into a family of shopkeepers", null), new MBList<SkillObject>{
                DefaultSkills.Trade,
                DefaultSkills.Charm
                },
                DefaultCharacterAttributes.Social, this.FocusToAdd, this.SkillLevelToAdd, this.AttributeLevelToAdd, null, default_middle_1_OnApply, default_middle_1_OnApply, new TextObject("You were part of the town's middle class, helping out in your family's shop all your life, offering sevices of different kinds to your clients and making a decent living of it.", null), null, 0, 0, 0, 0, 0);
            characterCreationCategoryCairhien.AddCategoryOption(new TextObject("a squire", null), new MBList<SkillObject>{
                DefaultSkills.OneHanded,
                DefaultSkills.Scouting
                },
            ...
            characterCreationCategoryIllian.AddCategoryOption(new TextObject("part of a farmer's household", null), new MBList<SkillObject>{
                DefaultSkills.Athletics,
                DefaultSkills.Riding
                },
                DefaultCharacterAttributes.Endurance, this.FocusToAdd, this.SkillLevelToAdd, this.AttributeLevelToAdd, null, default_poor_1_OnApply, default_poor_1_OnApply, new TextObject("You were raised at a farm in a rural area. A poor living and since you had elder brothers, they inhereted most of the farm, you were only left with your brains and clothes after you left the household.", null), null, 0, 0, 0, 0, 0);
            characterCreationCategoryIllian.AddCategoryOption(new TextObject("a relative of a wisdom", null), new MBList<SkillObject>{
                DefaultSkills.Medicine,
                DefaultSkills.Charm
                },
                DefaultCharacterAttributes.Social, this.FocusToAdd, this.SkillLevelToAdd, this.AttributeLevelToAdd, null, default_channeler_1_OnApply, default_channeler_1_OnApply, new TextObject("As a relative of your villages wisdom you had a good living, learning a lot from her. You even inherited the ability to channel from her, incredible luck.", null), null, 0, 0, 0, 0, 0);
            characterCreationCategoryIllian.AddCategoryOption(new TextObject("a daughter of a labourer", null), new MBList<SkillObject>{
                DefaultSkills.Crafting,
                DefaultSkills.OneHanded
                },
                DefaultCharacterAttributes.Vigor, this.FocusToAdd, this.SkillLevelToAdd, this.AttributeLevelToAdd, Female, default_poor_2_OnApply, default_poor_2_OnApply, new TextObject("Your father was a labourer, heading from town to town in search of jobs that suited his craft. He was working at construction sites, harbours and reparing for his entire life, sharing a great deal of that experience with you.", null), null, 0, 0, 0, 0, 0);
            characterCreationCategoryIllian.AddCategoryOption(new TextObject("a son of a labourer", null), new MBList<SkillObject>{
                DefaultSkills.Crafting,
                DefaultSkills.OneHanded
                },
                DefaultCharacterAttributes.Vigor, this.FocusToAdd, this.SkillLevelToAdd, this.AttributeLevelToAdd, Male, default_poor_2_OnApply, default_poor_2_OnApply, new TextObject("Your father was a labourer, heading from town to town in search of jobs that suited his craft. He was working at construction sites, harbours and reparing for his entire life, sharing a great deal of that experience with you.", null), null, 0, 0, 0, 0, 0);
            characterCreationCategoryIllian.AddCategoryOption(new TextObject("an Illianer companion", null), new MBList<SkillObject>{
                DefaultSkills.TwoHanded,
                DefaultSkills.Leadership
                },
            ...
            characterCreationCategoryIllian.AddCategoryOption(new TextObject("born into a family of shopkeepers", null), new MBList<SkillObject>{
                DefaultSkills.Trade,
                DefaultSkills.Charm
                },
                DefaultCharacterAttributes.Social, this.FocusToAdd, this.SkillLevelToAdd, this.AttributeLevelToAdd, null, default_middle_1_OnApply, default_middle_1_OnApply, new TextObject("You were part of the town's middle class, helping out in your family's shop all your life, offering sevices of different kinds to your clients and making a decent living of it.", null), null, 0, 0, 0, 0, 0);
            characterCreationCategoryIllian.AddCategoryOption(new TextObject("a hunter for the horn", null), new MBList<SkillObject>{
                DefaultSkills.Bow,
                DefaultSkills.Throwing
                },
            ...
            characterCreationCategoryTear.AddCategoryOption(new TextObject("part of a farmer's household", null), new MBList<SkillObject>{
                DefaultSkills.Athletics,
                DefaultSkills.Riding
                },
                DefaultCharacterAttributes.Endurance, this.FocusToAdd, this.SkillLevelToAdd, this.AttributeLevelToAdd, null, default_poor_1_OnApply, default_poor_1_OnApply, new TextObject("You were raised at a farm in a rural area. A poor living and since you had elder brothers, they inhereted most of the farm, you were only left with your brains and clothes after you left the household.", null), null, 0, 0, 0, 0, 0);
            characterCreationCategoryTear.AddCategoryOption(new TextObject("a relative of a wisdom", null), new MBList<SkillObject>{
                DefaultSkills.Medicine,
                DefaultSkills.Charm
                },
                DefaultCharacterAttributes.Social, this.FocusToAdd, this.SkillLevelToAdd, this.AttributeLevelToAdd, null, default_channeler_1_OnApply, default_channeler_1_OnApply, new TextObject("As a relative of your villages wisdom you had a good living, learning a lot from her. You even inherited the ability to channel from her, incredible luck.", null), null, 0, 0, 0, 0, 0);
            characterCreationCategoryTear.AddCategoryOption(new TextObject("a daughter of a labourer", null), new MBList<SkillObject>{
                DefaultSkills.Crafting,
                DefaultSkills.OneHanded
                },
                DefaultCharacterAttributes.Vigor, this.FocusToAdd, this.SkillLevelToAdd, this.AttributeLevelToAdd, Female, default_poor_2_OnApply, default_poor_2_OnApply, new TextObject("Your father was a labourer, heading from town to town in search of jobs that suited his craft. He was working at construction sites, harbours and reparing for his entire life, sharing a great deal of that experience with you.", null), null, 0, 0, 0, 0, 0);
            characterCreationCategoryTear.AddCategoryOption(new TextObject("a son of a labourer", null), new MBList<SkillObject>{
                DefaultSkills.Crafting,
                DefaultSkills.OneHanded
                },
                DefaultCharacterAttributes.Vigor, this.FocusToAdd, this.SkillLevelToAdd, this.AttributeLevelToAdd, Male, default_poor_2_OnApply, default_poor_2_OnApply, new TextObject("Your father was a labourer, heading from town to town in search of jobs that suited his craft. He was working at construction sites, harbours and reparing for his entire life, sharing a great deal of that experience with you.", null), null, 0, 0, 0, 0, 0);
            characterCreationCategoryTear.AddCategoryOption(new TextObject("a defender of the Stone", null), new MBList<SkillObject>{
                DefaultSkills.TwoHanded,
                DefaultSkills.Leadership
                },
            ...
            characterCreationCategoryTear.AddCategoryOption(new TextObject("a levy dodging service", null), new MBList<SkillObject>{
                DefaultSkills.Roguery,
                DefaultSkills.Riding
                },
            ...
            characterCreationCategoryTear.AddCategoryOption(new TextObject("a fresh noble knight", null), new MBList<SkillObject>{
                DefaultSkills.Polearm,
                DefaultSkills.Charm
                },
        ...
        protected void AddProfessionMenu(CharacterCreation characterCreation)
        {
            ...
            characterCreationCategory.AddCategoryOption(new TextObject("as a farmer", null), new MBList<SkillObject>{
                DefaultSkills.Scouting,
                DefaultSkills.Steward
                },
            ...
            characterCreationCategory.AddCategoryOption(new TextObject("as a blacksmith's apprentice", null), new MBList<SkillObject>{
                DefaultSkills.Crafting,
                DefaultSkills.Engineering
                },
            ...
            characterCreationCategory.AddCategoryOption(new TextObject("as a hunter in the woods", null), new MBList<SkillObject>{
                DefaultSkills.Scouting,
                DefaultSkills.Bow
                },
            ...
            characterCreationCategory.AddCategoryOption(new TextObject("as a merchant's assistant", null), new MBList<SkillObject>{
                DefaultSkills.Trade,
                DefaultSkills.Leadership
                },
            ...
            characterCreationCategory.AddCategoryOption(new TextObject("as a fisher", null), new MBList<SkillObject>{
                DefaultSkills.Throwing,
                DefaultSkills.Medicine
                },
            ...
            characterCreationCategory.AddCategoryOption(new TextObject("as a sheep herder", null), new MBList<SkillObject>{
                DefaultSkills.Riding,
                DefaultSkills.Bow
                },
            ...
            characterCreationCategory.AddCategoryOption(new TextObject("as a trolloc breeder", null), new MBList<SkillObject>{
                DefaultSkills.Riding,
                DefaultSkills.Bow
                },
            ...
            characterCreationCategory.AddCategoryOption(new TextObject("as a engineer on fortification", null), new MBList<SkillObject>{
                DefaultSkills.Engineering,
                DefaultSkills.Tactics
                },
            ...
            characterCreationCategory.AddCategoryOption(new TextObject("as a raider and bandit", null), new MBList<SkillObject>{
                DefaultSkills.Tactics,
                DefaultSkills.OneHanded
                },
            ...
            characterCreationCategory.AddCategoryOption(new TextObject("as a pirate", null), new MBList<SkillObject>{
                DefaultSkills.Tactics,
            ...
            characterCreationCategory.AddCategoryOption(new TextObject("as a stable hand", null), new MBList<SkillObject>{
                DefaultSkills.Riding,
                DefaultSkills.Throwing
                },
            ...
            characterCreationCategory.AddCategoryOption(new TextObject("as a healer", null), new MBList<SkillObject>{
                DefaultSkills.Medicine,
                DefaultSkills.Charm
                },
        ...
        protected void AddTalentMenu(CharacterCreation characterCreation)
        {
            ...
            characterCreationCategory.AddCategoryOption(new TextObject("fireballs", null), new MBList<SkillObject>{
                DefaultSkills.Throwing,
                DefaultSkills.Riding
                },
            ...
            characterCreationCategory.AddCategoryOption(new TextObject("windstorms", null), new MBList<SkillObject>{
                DefaultSkills.Throwing,
                DefaultSkills.OneHanded
                },
            ...
            characterCreationCategory.AddCategoryOption(new TextObject("lightning", null), new MBList<SkillObject>{
                DefaultSkills.Throwing,
                DefaultSkills.TwoHanded
                },
            ...
            characterCreationCategory.AddCategoryOption(new TextObject("rolling earth and fire", null), new MBList<SkillObject>{
                DefaultSkills.Throwing,
                DefaultSkills.Polearm
                },
            ...
            characterCreationCategory.AddCategoryOption(new TextObject("an airshield", null), new MBList<SkillObject>{
                DefaultSkills.Throwing,
                DefaultSkills.Bow
                },
            ...
            characterCreationCategory1.AddCategoryOption(new TextObject("a spear", null), new MBList<SkillObject>{
                DefaultSkills.Polearm,
                DefaultSkills.Athletics
                },
            ...
            characterCreationCategory1.AddCategoryOption(new TextObject("a short bow", null), new MBList<SkillObject>{
                DefaultSkills.Bow,
                DefaultSkills.Athletics
                },
            ...
            characterCreationCategory1.AddCategoryOption(new TextObject("a crossbow", null), new MBList<SkillObject>{
                DefaultSkills.Crossbow,
                DefaultSkills.Athletics
                },
            ...
            characterCreationCategory1.AddCategoryOption(new TextObject("a throwing spear", null), new MBList<SkillObject>{
                DefaultSkills.Throwing,
                DefaultSkills.Athletics
                },
            ...
            characterCreationCategory1.AddCategoryOption(new TextObject("a sword", null), new MBList<SkillObject>{
                DefaultSkills.OneHanded,
                DefaultSkills.TwoHanded
                },
            ...
            characterCreationCategory1.AddCategoryOption(new TextObject("on horseback", null), new MBList<SkillObject>{
                DefaultSkills.Riding,
                DefaultSkills.Polearm
                },
            ...
            characterCreationCategory1.AddCategoryOption(new TextObject("with a buckler", null), new MBList<SkillObject>{
                DefaultSkills.OneHanded,
                DefaultSkills.Athletics
                },
            ...
            characterCreationCategory1.AddCategoryOption(new TextObject("with a longbow", null), new MBList<SkillObject>{
                DefaultSkills.Bow,
                DefaultSkills.Athletics
                },
        ...
        protected void AddSpawnMenu(CharacterCreation characterCreation)
        {
            ...
            characterCreationCategory.AddCategoryOption(new TextObject("the Great Blight", null), new MBList<SkillObject>{
                DefaultSkills.Bow,
                DefaultSkills.Athletics
                },
            ...
            characterCreationCategory.AddCategoryOption(new TextObject("the Waste", null), new MBList<SkillObject>{
                DefaultSkills.Bow,
                DefaultSkills.Athletics
                },
            ...
            characterCreationCategory.AddCategoryOption(new TextObject("Andor", null), new MBList<SkillObject>{
                DefaultSkills.Bow,
                DefaultSkills.Athletics
                },
            ...
            characterCreationCategory.AddCategoryOption(new TextObject("Mayene", null), new MBList<SkillObject>{
                DefaultSkills.Bow,
                DefaultSkills.Athletics
                },
            ...
            characterCreationCategory.AddCategoryOption(new TextObject("Malkier", null), new MBList<SkillObject>{
                DefaultSkills.Bow,
                DefaultSkills.Athletics
                },
            ...
            characterCreationCategory.AddCategoryOption(new TextObject("the White Tower", null), new MBList<SkillObject>{
                DefaultSkills.Bow,
                DefaultSkills.Athletics
                },
